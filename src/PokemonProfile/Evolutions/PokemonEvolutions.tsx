              ...
              <div key={index} className='evolution-set'>
                {evolution.map((pokemon: Evolution) => (
                  <div key={pokemon.id} className='evolution'>
                    <div className='evolution-info' onClick={() => nav(`/${pokemon.id}`)}>
                    <img className='evolution-image' src={pokemon.image} alt={pokemon.name} />
                    <div className='evolution-name'>#{pokemon.id} {pokemon.name}</div>
                    </div>
                  </div>
                ))}
              </div>
